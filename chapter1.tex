...
\end{problem}
\begin{solution}
  We can map $\Gamma_f$ to $A$ using $f: \langle a, f(a)\rangle \mapsto a$ and
  $f^{-1}: a \mapsto \langle a, f(a) \rangle$. These two functions form
  an isomorphism since both $f \circ f^{-1}$ and $f^{-1} \circ f$ are identities.
\end{solution}
